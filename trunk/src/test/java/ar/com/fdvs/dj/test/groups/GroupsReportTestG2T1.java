...
//		 define the criteria column to group by (columnState)
		ColumnsGroup g1 = gb1.setCriteriaColumn((PropertyColumn) columnState)
				.addFooterVariable(columnAmount,ColumnsGroupVariableOperation.SUM,g1VariablesStyle) 
				.addFooterVariable(columnaQuantity,ColumnsGroupVariableOperation.SUM,g1VariablesStyle) 
