...
class DJChartOptionsTest {
    ...
    class ConstantsTests {
        ...
        @Test
        void edgeConstants() {
            // JR 6.21 value: DJChartOptions.EDGE_* is EdgeEnum.getValue() (1-indexed in
            // JR 6.21.5), not the 0-indexed ordinal() values used on the JR7 branch.
            assertEquals((byte) 1, DJChartOptions.EDGE_TOP);
            assertEquals((byte) 2, DJChartOptions.EDGE_BOTTOM);
            assertEquals((byte) 3, DJChartOptions.EDGE_LEFT);
            assertEquals((byte) 4, DJChartOptions.EDGE_RIGHT);
        }
