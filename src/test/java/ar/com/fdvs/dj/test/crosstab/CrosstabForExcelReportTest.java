...
public class CrosstabForExcelReportTest extends BaseDjReportTest {
...
//			.setPageSizeAndOrientation(Page.Page_A4_Landscape())
			...
			.setPageSizeAndOrientation(new Page(2000,3000,true))
...
//			.addRow("Id", "id", Long.class.getName(),true)
	...
	public static void main(String[] args) throws Exception {
		CrosstabForExcelReportTest test = new CrosstabForExcelReportTest();
		test.testReport();
