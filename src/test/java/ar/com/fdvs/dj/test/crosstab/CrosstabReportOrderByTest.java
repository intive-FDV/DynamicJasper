...
public class CrosstabReportOrderByTest extends BaseDjReportTest {
	...
	public DynamicReport buildReport() throws Exception {
		...
		// Order items, by descending ID
		
		row = new CrosstabRowBuilder().setProperty("item",String.class.getName())
			.setOrderBy("id", Long.class)
			.setOrder(DJCrosstabBucketOrder.DESCENDING)
	...
	public static void main(String[] args) throws Exception {
		CrosstabReportOrderByTest test = new CrosstabReportOrderByTest();
		test.testReport();
