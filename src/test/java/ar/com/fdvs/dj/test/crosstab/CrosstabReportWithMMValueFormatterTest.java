...
public class CrosstabReportWithMMValueFormatterTest extends BaseDjReportTest {
	...
	public DynamicReport buildReport() throws Exception {
		...
		DJCrosstab djcross = new CrosstabBuilder()
			...
			.addMeasure("quantity",Long.class.getName(), DJCalculation.FIRST , "Time",measureStyle2, new DjBaseMMValueFormatter() {

				public String getClassName() {
					return String.class.getName();
				}

				public Object innerEvaluate(Object[] value, Map fields, Map variables, Map parameters) {
					Long val = (Long)value[0];
	...
	public static void main(String[] args) throws Exception {
		CrosstabReportWithMMValueFormatterTest test = new CrosstabReportWithMMValueFormatterTest();
		test.testReport();
