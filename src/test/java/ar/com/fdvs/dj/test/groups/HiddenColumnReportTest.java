...
public class HiddenColumnReportTest extends BaseDjReportTest {
	...
	public DynamicReport buildReport() throws Exception {
		...
		specialDetailStyle.setFont(Font.VERDANA_BIG);
//		specialDetailStyle.setBorderBottom(Border.PEN_2_POINT());
		...
		AbstractColumn columnState = ColumnBuilder.getNew()
				...
				.setStyle(specialDetailStyle).setHeaderStyle(headerStyle).build();

		AbstractColumn columnBranch = ColumnBuilder.getNew()
				.setColumnProperty("branch", String.class.getName()).setTitle(
						"Branch").setWidth(new Integer(85))
						.setStyle(specialDetailStyle2).setHeaderStyle(headerStyle).build();
...
//		 define the criteria column to group by (columnState)
	...
	public static void main(String[] args) throws Exception {
		HiddenColumnReportTest test = new HiddenColumnReportTest();
		test.testReport();
