 ...
 *
 */
public class SummaryCrosstabTest extends BaseDjReportTest {
...
//			.addMeasure("id",Long.class.getName(), DJCalculation.SUM , "Id", measureStyle)
		...
		drb.addSummaryCrosstab(djcross); //add the crosstab in the summary band of the report
...
//		params.put("sr", SortUtils.sortCollection(TestRepositoryProducts.getDummyCollection(),djcross));
	...
	public void testReport() throws Exception {
		...
		Assert.assertEquals("10,000", getCellText(crosstab, i++));
		Assert.assertEquals("10,000", getCellText(crosstab, i++));
		Assert.assertEquals("10,000", getCellText(crosstab, i++));
		...
		Assert.assertEquals("12,831.32", getCellText(crosstab, i++));
		Assert.assertEquals("12,831.32", getCellText(crosstab, i++));
		Assert.assertEquals("12,831.32", getCellText(crosstab, i++));
	 ...
	 * 
	 * @param crosstab the crosstab frame
	...
	public static void main(String[] args) throws Exception {
		SummaryCrosstabTest test = new SummaryCrosstabTest();
		test.testReport();
