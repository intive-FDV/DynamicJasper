...
/**
 * The idea is to create report and pass an empty datasource to test the NO-DATA section with other elements such as
 * title, header, etc.
 * 
 * @author mamana
 *
 */
public class WhenNoDataTest2 extends BaseDjReportTest {
...
//			.setWhenNoData("No data for this report", noDataStyle,true,false)
	...
	public static void main(String[] args) throws Exception {
		WhenNoDataTest2 test = new WhenNoDataTest2();
		test.testReport();
