 ...
 *
 */
public class CrosstabInHeaderIgnoresFirstRowTest extends BaseDjReportTest {
...
//		params.put("sr", SortUtils.sortCollection(TestRepositoryProducts.getDummyCollection(),djcross));
	...
	public static void main(String[] args) throws Exception {
		CrosstabInHeaderIgnoresFirstRowTest test = new CrosstabInHeaderIgnoresFirstRowTest();
		test.testReport();
