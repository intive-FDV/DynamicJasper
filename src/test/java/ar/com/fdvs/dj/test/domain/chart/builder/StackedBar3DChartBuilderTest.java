...
public class StackedBar3DChartBuilderTest extends BaseDjReportTest {
...
/*		GroupBuilder gb2 = new GroupBuilder(); 
		...
		DJChart djChart = new DJStackedBar3DChartBuilder()
		//chart		
		.setX(20)
		.setY(10)
		.setWidth(500)
	...
	public static void main(String[] args) throws Exception {
		StackedBar3DChartBuilderTest test = new StackedBar3DChartBuilderTest();
		test.setUp();
		test.testReport();
