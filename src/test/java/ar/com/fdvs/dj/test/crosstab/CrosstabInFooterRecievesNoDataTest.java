 ...
 *
 */
public class CrosstabInFooterRecievesNoDataTest extends BaseDjReportTest {
...
//		params.put("sr", SortUtils.sortCollection(TestRepositoryProducts.getDummyCollection(),djcross));
	...
	public static void main(String[] args) throws Exception {
		CrosstabInFooterRecievesNoDataTest test = new CrosstabInFooterRecievesNoDataTest();
		test.testReport();
