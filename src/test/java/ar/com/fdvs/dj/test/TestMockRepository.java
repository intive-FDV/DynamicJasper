...
public class TestMockRepository {
	...
	public static Collection getDummyCollection(){
		...
		col.add(new Product( 1L,"book","Harry Potter 7","Florida","Main Street", 2500L, 5f));
		col.add(new Product( 1L,"book","Harry Potter 7","Florida","Railway Station", 1400L, 10f));
		col.add(new Product( 1L,"book","Harry Potter 7","Florida","Baseball Stadium", 4000L, 5f));
...
//		col.add(new Product( 1L,"book","Harry Potter 7","New York","Railway Station", 1400L, 3322f));
		col.add(new Product( 1L,"book","Harry Potter 7","New York","Baseball Stadium", 4000L, 3f));
		col.add(new Product( 1L,"book","Harry Potter 7","New York","Shopping Center", 3000L, 10f));
...
//		col.add(new Product( 1L,"book","Harry Potter 7","Arizona","Baseball Stadium", 3000L, 78482f));
//		col.add(new Product( 1L,"book","Harry Potter 7","Arizona","Shopping Center", 1500L, 5831.32f));
		col.add(new Product( 2L,"book","The Sum of All Fears","Florida","Main Street", 8400L, 8f));
...
//		col.add(new Product( 2L,"book","The Sum of All Fears","Arizona","Main Street", 4000L, 9482.4f));
//		col.add(new Product( 2L,"book","The Sum of All Fears","Arizona","Railway Station", 3000L, 8329.2f));
//		col.add(new Product( 2L,"book","The Sum of All Fears","Arizona","Baseball Stadium", 1500L, 27475.5f));
//		col.add(new Product( 2L,"book","The Sum of All Fears","Arizona","Shopping Center", 8400L, 3322f));
...
//		col.add(new Product( 3L,"book","The Pelican Brief,","Arizona","Shopping Center", 1400L, 8329.2f));
		col.add(new Product( 4L,"dvd","Titanic","Florida","Main Street", 4000L, 10f));
		col.add(new Product( 4L,"dvd","Titanic","Florida","Railway Station", 3000L, 3f));
//		col.add(new Product( 4L,"dvd","Titanic","Florida","Baseball Stadium", 1500L, 80f));
