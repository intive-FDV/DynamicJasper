...
public class CrosstabReportWithValueFormatterTest extends BaseDjReportTest {
...
//			.addMeasure("id",Long.class.getName(), DJCalculation.SUM , "Id", measureStyle)
			.addMeasure("quantity",Long.class.getName(), DJCalculation.FIRST , "Time",measureStyle2, new DJValueFormatter() {
	...
	public static void main(String[] args) throws Exception {
		CrosstabReportWithValueFormatterTest test = new CrosstabReportWithValueFormatterTest();
		test.testReport();
