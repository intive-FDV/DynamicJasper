...
//		col.add(new Product( new Long("10"),"food","snickers","Arizona","Shopping Center", new Long("4000"), new Float("5831.32")));
	...
	public static List getDummyCollectionSmall(){
		...
		//The collection is ordered by State, Branch and Product Line
		col.add(new Product( new Long("1"),"book","Harry Potter 7","Florida","Main Street", new Long("250"), new Float("10000")));
		col.add(new Product( new Long("1"),"book","Harry Potter 7","Florida","Railway Station", new Long("400"), new Float("2831.32")));
		col.add(new Product( new Long("1"),"book","Harry Potter 7","Florida","Baseball Stadium", new Long("440"), null));
		col.add(new Product( new Long("1"),"book","Harry Potter 7","Florida","Shopping Center", new Long("300"), new Float("9482.4")));
		col.add(new Product( new Long("1"),"book","Harry Potter 7","New York","Main Street", new Long("500"), new Float("27475.5")));
		col.add(new Product( new Long("1"),"book","Harry Potter 7","New York","Railway Station", new Long("640"), new Float("3322")));
		col.add(new Product( new Long("1"),"book","Harry Potter 7","New York","Baseball Stadium", new Long("100"), new Float("78482")));
		col.add(new Product( new Long("1"),"book","Harry Potter 7","New York","Shopping Center", new Long("70"), new Float("5831.32")));
		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Washington","Main Street",null, new Float("3322")));
		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Washington","Railway Station", new Long("98"), new Float("78482")));
		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Washington","Baseball Stadium", new Long("613"), new Float("5831.32")));
		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Washington","Shopping Center", new Long("87"), null));
		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Arizona","Main Street", new Long("250"), new Float("2831.32")));
		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Arizona","Railway Station", new Long("550"), new Float("38347")));
