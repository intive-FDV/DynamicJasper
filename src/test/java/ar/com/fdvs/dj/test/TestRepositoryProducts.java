...
//		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Florida","Shopping Center", new Long("1500"), new Float("2831.32")));
		...
		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Main Street", new Long("3000"), new Float("2831.32")));
		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Railway Station", new Long("1500"), new Float("38347")));
//		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Baseball Stadium", new Long("8400"), new Float("9482.4")));
		col.add(new Product( new Long("3"),"book","The Pelican Brief,","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Shopping Center", new Long("1400"), new Float("8329.2")));
		...
		col.add(new Product( new Long("4"),"dvd","Titanic","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Main Street", new Long("1500"), new Float("5831.32")));
		col.add(new Product( new Long("4"),"dvd","Titanic","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Railway Station", new Long("8400"), new Float("3322")));
//		col.add(new Product( new Long("4"),"dvd","Titanic","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Baseball Stadium", new Long("1400"), new Float("78482")));
		col.add(new Product( new Long("4"),"dvd","Titanic","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Shopping Center", new Long("4000"), new Float("5831.32")));
...
//		col.add(new Product( new Long("5"),"dvd","Back To the Future","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Main Street", new Long("8400"), new Float("9482.4")));
//		col.add(new Product( new Long("5"),"dvd","Back To the Future","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Railway Station", new Long("1400"), new Float("8329.2")));
//		col.add(new Product( new Long("5"),"dvd","Back To the Future","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Baseball Stadium", new Long("4000"), new Float("27475.5")));
//		col.add(new Product( new Long("5"),"dvd","Back To the Future","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Shopping Center", new Long("3000"), new Float("3322")));
...
//		col.add(new Product( new Long("6"),"dvd","Monsters Inc","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Main Street", new Long("1400"), new Float("78482")));
//		col.add(new Product( new Long("6"),"dvd","Monsters Inc","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Railway Station", new Long("4000"), new Float("5831.32")));
//		col.add(new Product( new Long("6"),"dvd","Monsters Inc","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Baseball Stadium", new Long("3000"), new Float("78482")));
//		col.add(new Product( new Long("6"),"dvd","Monsters Inc","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Shopping Center", new Long("1500"), new Float("2831.32")));
...
//		col.add(new Product( new Long("7"),"magazine","Sports Illustrated","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Main Street", new Long("4000"), new Float("38347")));
//		col.add(new Product( new Long("7"),"magazine","Sports Illustrated","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Railway Station", new Long("3000"), new Float("9482.4")));
//		col.add(new Product( new Long("7"),"magazine","Sports Illustrated","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Baseball Stadium", new Long("1500"), new Float("8329.2")));
//		col.add(new Product( new Long("7"),"magazine","Sports Illustrated","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Shopping Center", new Long("2500"), new Float("27475.5")));
...
//		col.add(new Product( new Long("8"),"magazine","The Economist","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Main Street", new Long("3000"), new Float("3322")));
//		col.add(new Product( new Long("8"),"magazine","The Economist","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Railway Station", new Long("1500"), new Float("78482")));
//		col.add(new Product( new Long("8"),"magazine","The Economist","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Baseball Stadium", new Long("2500"), new Float("5831.32")));
//		col.add(new Product( new Long("8"),"magazine","The Economist","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Shopping Center", new Long("1400"), new Float("78482")));
...
//		col.add(new Product( new Long("9"),"magazine","National Geographic","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Main Street", new Long("1400"), new Float("2831.32")));
//		col.add(new Product( new Long("9"),"magazine","National Geographic","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Railway Station", new Long("4000"), new Float("38347")));
//		col.add(new Product( new Long("9"),"magazine","National Geographic","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Baseball Stadium", new Long("3000"), new Float("9482.4")));
//		col.add(new Product( new Long("9"),"magazine","National Geographic","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Shopping Center", new Long("1500"), new Float("8329.2")));
...
//		col.add(new Product( new Long("10"),"food","snickers","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Main Street", new Long("1500"), new Float("27475.5")));
//		col.add(new Product( new Long("10"),"food","snickers","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Railway Station", new Long("8400"), new Float("3322")));
//		col.add(new Product( new Long("10"),"food","snickers","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Baseball Stadium", new Long("1400"), new Float("78482")));
//		col.add(new Product( new Long("10"),"food","snickers","Arizona CustomExpressions can't be grouped (it doesn't crash, but there's always just 1 group in the output even when there should be more). ","Shopping Center", new Long("4000"), new Float("5831.32")));
