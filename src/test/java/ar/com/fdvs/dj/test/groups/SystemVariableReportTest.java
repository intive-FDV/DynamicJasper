...
public class SystemVariableReportTest extends BaseDjReportTest {
...
//		 define the criteria column to group by (columnState)
	...
	/**
	 * Silly method to illustrate that that the scriptlet is initialized with precalculated values 
	 * @return
	 */
	...
	public static void main(String[] args) throws Exception {
		SystemVariableReportTest test = new SystemVariableReportTest();
		test.testReport();
