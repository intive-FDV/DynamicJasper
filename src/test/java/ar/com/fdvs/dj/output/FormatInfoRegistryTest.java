...
public class FormatInfoRegistryTest {
    ...
    public void testGetExporterHtml() {
        Exporter exporter = FormatInfoRegistry.getInstance().getExporter(DJConstants.FORMAT_HTML);
    ...
    public void testGetExporterCsv() {
        Exporter exporter = FormatInfoRegistry.getInstance().getExporter(DJConstants.FORMAT_CSV);
    ...
    public void testGetExporterXml() {
        Exporter exporter = FormatInfoRegistry.getInstance().getExporter(DJConstants.FORMAT_XML);
    ...
    public void testGetExporterRtf() {
        Exporter exporter = FormatInfoRegistry.getInstance().getExporter(DJConstants.FORMAT_RTF);
    ...
    @Test
    public void testGetXlsConfiguration() {
        SimpleXlsReportConfiguration config = FormatInfoRegistry.getInstance().getXlsConfiguration();

        assertNotNull("XLS configuration should not be null", config);
        assertFalse("White page background should be false", config.isWhitePageBackground());
        assertTrue("Remove empty space should be true", config.isRemoveEmptySpaceBetweenRows());
    }
}
