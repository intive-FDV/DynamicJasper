...
public class LayoutUtilsTest {
    ...
    public void testConvertBorderToPen() {
        ...
        assertEquals("Line style should be solid", LineStyleEnum.SOLID, rect.getLinePen().getLineStyleValue());
    }
    ...
    public void testConvertBorderToPenDashed() {
        ...
        assertEquals("Line style should be dashed", LineStyleEnum.DASHED, rect.getLinePen().getLineStyleValue());
    }

    @Test
    public void testGetBandFromSection() {
        JRDesignSection section = new JRDesignSection(new JROrigin(BandTypeEnum.DETAIL)) {};
        JRDesignBand band = new JRDesignBand();
        band.setHeight(50);
