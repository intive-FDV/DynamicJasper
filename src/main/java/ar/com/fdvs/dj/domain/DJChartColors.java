...
public class DJChartColors extends DJBaseElement {
	...
	public static List<Color> msOfficePurples() {
	...
	public static List<Color> simpleColors() {
	...
	public static List<Color> desert() {
	...
	public static List<Color> justAnotherColorScheme() {
	...
	public static List<Color> googleAnalytics() {
