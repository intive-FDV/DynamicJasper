...
public class LayoutUtils {
    ...
    public static void registerCustomExpressionParameter(DynamicJasperDesign design, String name, CustomExpression customExpression) {
        registerCustomExpressionParameter(design, design.getParametersWithValues(), name, customExpression);
    }

    public static void registerCustomExpressionParameter(JasperDesign design, Map parametersMap, String name, CustomExpression customExpression) {
        if (customExpression == null) {
            return;
        }
        registerParameterWithValue(design, parametersMap, name, customExpression);
    }

    public static void registerParameterWithValue(DynamicJasperDesign design, String name, Object value) {
        registerParameterWithValue(design, design.getParametersWithValues(), name, value);
    }

    public static void registerParameterWithValue(JasperDesign design, Map parametersMap, String name, Object value) {
        JRDesignParameter dparam = new JRDesignParameter();
        dparam.setName(name);
        if (value != null)
            dparam.setValueClassName(value.getClass().getName());
        else
            dparam.setValueClassName(Object.class.getName());
