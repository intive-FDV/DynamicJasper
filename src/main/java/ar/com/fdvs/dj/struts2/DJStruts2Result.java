 ...
 *         Time: 4:32:34 PM
 */
public class DJStruts2Result extends JasperReportsResult {

	private static final long serialVersionUID = -5135527859073133975L;

	private static final Log LOG = LogFactory.getLog(DJStruts2Result.class);
    ...
    /**
     * Due to private access in StrutsResultSupport we our own copy.
     */
    ...
    public void setParse(final boolean _parse) {
    ...
    protected void checkParams() {
        if (dynamicReport == null) {
            ...
            LOG.error(message);
            throw new StrutsException(message);
        }
